package com.soft1851.content.center.util;
...
//    // 将这串字符还原为上面生成的token!!!
    String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2MDI1NzMzNjgsImV4cCI6MTYwMzc4Mjk2OH0.265foT5tAIKCoveU-bzaTLBvfW3zieGjbnVmUgk8ytY";
...
//
//    // token的第二段（以.为边界）
    String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE2MDI1NzMzNjgsImV4cCI6MTYwMzc4Mjk2OH0";
    // 测试5: 解密Payload
